...
def init_state() -> None:
    defaults = {
        ...
        "last_pdf_path": "",
        "divergence_rate_threshold": 25.0,
        "current_step": 0,
        "notice": "",
    }
...
def consolidation_inputs() -> None:
    ...
    divergence_rate_threshold = st.slider(
        "Limite percentual de divergencia para destaque no PDF",
        min_value=0,
        max_value=100,
        value=int(st.session_state.divergence_rate_threshold),
        step=5,
        help="Se o percentual de cruzamentos divergentes superar este valor, o relatorio destacara o desalinhamento.",
    )
    ...
    if st.button("Consolidar", type="primary"):
        ...
        st.session_state.divergence_rate_threshold = float(divergence_rate_threshold)
...
def export_inputs() -> None:
    ...
    pdf_kwargs = dict(
        ...
        divergence_rate_threshold=st.session_state.divergence_rate_threshold,
